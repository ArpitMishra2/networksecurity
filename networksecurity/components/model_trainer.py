...
import dagshub
dagshub.init(repo_owner='ArpitMishra2', repo_name='networksecurity', mlflow=True)
...
class ModelTrainer:
    ...
    def track_mlflow(self,best_model,classificationmetric):
        mlflow.set_registry_uri("https://dagshub.com/ArpitMishra2/networksecurity.mlflow")
